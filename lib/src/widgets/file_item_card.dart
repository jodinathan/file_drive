...
class _FileItemCardState extends State<FileItemCard> {
  ...
  Widget _buildFileIcon(ThemeData theme) {
    ...
    return FileThumbnail(
      ...
      hasThumbnail:
          widget.file.hasThumbnail && widget.providerSupportsThumbnails,
  ...
  String? _getFileTypeDescription() {
    ...
    final hasCommonExtension = RegExp(
      r'\.(jpg|jpeg|png|gif|bmp|svg|pdf|doc|docx|xls|xlsx|ppt|pptx|txt|csv|zip|rar|mp4|mp3|wav|avi)$',
    ).hasMatch(fileName);
